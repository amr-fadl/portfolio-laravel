    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-secondary">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('service.store') }}" class="myform" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mt-3">
                            ...
                            <textarea id="inputmini_description" name="mini_description" class="form-control" rows="4"></textarea>
                        ...
                        <div class="mt-4">
                            <div class="custom-file">
                                <input type="file" name="images[]" multiple onchange="showPrev(event, this)" class="custom-file-input" id="customFile">
