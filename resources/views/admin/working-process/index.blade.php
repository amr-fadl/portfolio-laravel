        ...
        <div class="col-md-6">
            <div class="card card-secondary">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Working Process Config') }}</h3>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('workingProcessconfig.update' , $data->id) }}" class="myform" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mt-3">
