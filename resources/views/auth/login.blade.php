        ...
        <div class="modal">
            <div class="modal__container">
                ...
                <div class="modal__content">
                    <h2 class="title_form">{{ __('Login') }}</h2>
                        ...
                        <ul class="form-list">
                            ...
                            <li class="form-list__row">
                                ...
                                <x-text-input id="email" class="form-control" placeholder="" type="text"
                                    name="email" autocomplete="new-password" :value="old('email')" required />
                                <label>{{ __('Name Or Email') }}</label>
                            </li>
                            ...
                            <li>
                                <x-primary-button class="button"><small><i
                                            class="far fa-user pr-2"></i>{{ __('Login') }}</small>
                                </x-primary-button>
                                {{-- <div class="br_or">OR</div> --}}
                                <a class="button btn_two" href="{{ route('register') }}">
                                    <small><i class="far fa-user pr-2"></i>{{ __('Create Account') }}</small>
                                </a>
                            </li>
                        </ul>
                    </form>
